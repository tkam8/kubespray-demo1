...
module "compute" {
  ...
  number_of_calicorr                           = "${var.number_of_calicorr}"
  ...
  number_of_k8s_nodes                          = "${var.number_of_k8s_nodes}"
  #sriov_net1_id                                = "${var.sriov_net1_id}"
  #sriov_net1_subnet1_id                        = "${var.sriov_net1_subnet1_id}"
  #sriov_net2_id                                = "${var.sriov_net2_id}"
  #sriov_net2_subnet1_id                        = "${var.sriov_net2_subnet1_id}"
  #number_of_bastions                           = "${var.number_of_bastions}"
  ...
  calicorr_root_volume_size_in_gb              = "${var.calicorr_root_volume_size_in_gb}"
  ...
  flavor_calicorr                              = "${var.flavor_calicorr}"
